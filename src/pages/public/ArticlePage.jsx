  ...
  return (
    <div className="page-container max-w-4xl">
      ...
      <article className="prose dark:prose-invert prose-slate max-w-none transition-colors
        ...
        prose-code:text-accent-600 dark:prose-code:text-accent-300 prose-code:bg-slate-100 dark:prose-code:bg-dark-700 prose-code:px-1 prose-code:py-0.5 prose-code:rounded
